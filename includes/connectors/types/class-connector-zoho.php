...
class Connector_Zoho extends Connector_Base {
	...
	protected $name        = 'zoho-mail';
	protected $title       = 'Zoho';
	protected $disabled    = true;
	protected $description = 'Zoho is a popular and robust payment processing platform that allows businesses and websites to accept credit card payments online.';
	protected $logo        = 'Zoho';
	protected $full_logo   = '';
