 ...
 * @since 1.0
 */
class Connector_Amazon_SES extends Connector_Base {

	protected $name        = 'amazon-ses';
	protected $title       = 'Amazon SES';
	protected $disabled    = true;
	protected $description = 'Amazon SES is a popular and robust payment processing platform that allows businesses and websites to accept credit card payments online.';
