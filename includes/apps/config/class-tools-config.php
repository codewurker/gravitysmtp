				...
				'tools' => array(
					...
					'i18n' => array(
						...
						'send_a_test'                 => array(
							...
							'send_test_box_alerts_heading'                  => esc_html__( 'HTML Emails', 'gravitysmtp' ),
							'send_test_box_alerts_text'                     => esc_html__( 'Send this email in HTML or plain text format.', 'gravitysmtp' ),
