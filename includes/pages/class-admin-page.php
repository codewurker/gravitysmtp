...
class Admin_Page {
	...
	public function admin_pages() {
		if ( Feature_Flag_Manager::is_enabled( App_Service_Provider::FEATURE_FLAG_DASHBOARD ) ) {
			$this->pages_with_dashboard();
			return;
		}
	...
	// @todo - rename this method back to admin_pages() once the feature flag is enabled.
	private function pages_with_dashboard() {
